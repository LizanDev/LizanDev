...
|----------|-------|-----------|
| [Pipeline Farmacéutico](https://github.com/LizanDev/farmacia_fastAPI_PySpark) | PySpark · FastAPI · Streamlit | ETL escalable a millones de registros |
| [Auditor HTTP](https://github.com/LizanDev/http_header_auditor) | Python · TCP/SSL · regex | 77% de 100 sitios reales obtuvo nota F |
| [API Gestión de Tareas](https://github.com/LizanDev/api_tareas_projectos) | Django REST · JWT · PostgreSQL | 20+ tests · CI/CD · desplegado en Render |
| [Control Glucémico IA](https://github.com/LizanDev/control_azucar) | FastAPI · GPT-4o · pandas | +40% precisión tras 12 iteraciones QA |
| [Monitor Web + Telegram](https://github.com/LizanDev/monitoreo_web) | Python · requests · Telegram API | Detección de caídas en < 30s |
